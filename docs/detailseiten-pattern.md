...
| Zone 3 **Fakten** | D4, D25 | `FieldList` (0006), die Facts der Entitäten, `ProvenanceMark` (0163) | ausbessern | `FieldList` setzt jeden Wert rechts und fett und kann **keinen Satz** tragen; zwei Aufrufer bauen denselben Umweg in `v3.css` (`.v2btxf__note`, `.v3prov__note` — 0006, Nachtrag) | **S1** |
