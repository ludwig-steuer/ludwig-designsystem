...
| Warum nicht so lassen | eine Datei mit 1.090 Zeilen und sechs Reitern (Übersicht · Durchgänge · Buchungen · Artefakte · DATEV · Log) — die Reiter sind nach Datenquelle geschnitten, nicht nach Zielgruppe |
| Vertagt, weil | eine eigene Route zuerst ein Seitenprofil braucht (`docs/seiten/stapel-detail.md`: Job, Fragen in Reihenfolge, was hier nicht hingehört); ohne es sind die Reiter geraten |
