...
| J-35 | Kanzlei (Seitenrolle) | im Mahnlauf | die offenen Posten nach Alter gruppieren (Mahnstufen) | nicht genannt | im Mahnlauf | `seiten/opos.md` §Nebenjobs | open-item | — „eine Gruppierung, die es heute nicht gibt"; `OpenItemAgeGroup` steht bereit, die Mahnstufen-Spalte fehlt der Seite (Zweifel 1) | unbedient |
