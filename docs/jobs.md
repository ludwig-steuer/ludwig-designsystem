...
| J-54 | Sachbearbeiterin (Kanzlei) | ein Mandant ist übernommen | alle Dauerbuchungs-Regeln nebeneinander sehen | erkennen, welche stillsteht, welche kein Personenkonto hat und welche doppelt greift | unbekannt | 1 · 3 · 26 Regeln je Mandant (drei Mandanten im Bestand) — `entitaeten/recurring-rule.md` §Listen | recurring-rule | — die Seite gibt es noch nicht. **Ort seit 2026-09-08 entschieden** (Reiter `configuration/recurring-rules`), Seitenprofil liegt (`docs/seiten/regelwerk-mandant.md`), Baustein 0131 entsteht | unbedient |
