...
export const s3ProposalFromLastMonth: BankBalanceComparison = {
  ...
  ledger: {
    ...
    withProposals: {
      ...
      oldParts: [
        { label: "DATEV bis 31.07.", amount: 41250, detail: "Abruf 14.09.2026 21:42", proposed: false },
        {
...
const s10Ledger = {
  ...
  oldParts: [
    { label: "DATEV bis 31.07.", amount: 109870.12, detail: "Abruf 14.09.2026 21:42", proposed: false },
    { label: "Stapel 2026-0003", amount: 1985.3, detail: "freigegeben 18.08.2026, noch nicht in DATEV", proposed: false },
    { label: "Mandantenstapel Kasse", amount: 490.25, detail: "Kassenbuch Juli, vom Mandanten erfasst", proposed: false },
  ],
  movement: 18765.43,
  movementCount: 214,
