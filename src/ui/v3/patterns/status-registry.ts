 ...
 * es irgendwann als neues Tool oder geänderten Ablauf. Der Zielort einer
 * übernommenen Meldung ist ein `P<n>` im passenden Themen-Dossier.
 */
const PRODUKTBEFUND: Record<string, StatusDescriptor> = {
  ...
  accepted: { label: "Übernommen", kind: "success", description: "Behoben oder als P-Eintrag im Themen-Dossier festgehalten." },
 ...
 * Werte, die keine Spaltenwerte sind (angehängt mit 0074, Register L-41).
 *
 ...
 *
 * Wertebereich: DB-CHECK auf `completed_via` (sechs Werte). Ein TS-Enum gibt
 * es nicht; die lokale Union `SourceDocCompletionVia` in `SourceDocument.tsx`
 * spiegelt ihn (Register L-47).
 *
