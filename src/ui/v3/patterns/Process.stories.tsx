...
export const Failed: Story = {
  render: () => (
    <ProcessStepper
      phases={withStatus({ review: "done", handover: "failed" })}
      owner={BRIDGE}
      alarm
...
export const InRow: Story = {
  render: () => (
    <div style={{ display: "grid", gridTemplateColumns: "80px 1fr", gap: "var(--space-4)", alignItems: "center" }}>
      ...
      <Baton owner={FIRM} detail="seit 3 Tagen" />
      <ProcessMini phases={withStatus({ review: "done", handover: "done", lookup: "active" })} />
      <Baton owner={DATEV} />
      <ProcessMini phases={withStatus({ review: "done", handover: "failed" })} />
...
export const Empty: Story = {
  render: () => <ProcessStepper phases={withStatus({ book: "pending", review: "pending" })} owner={NOBODY} />,
};
