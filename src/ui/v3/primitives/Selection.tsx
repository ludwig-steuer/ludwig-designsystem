 ...
 *
 * @wann  Handlungen auf mehrere gewählte Zeilen zugleich.
 * @nicht Handlung an genau einer Zeile → RowActions.
 */
 ...
 *
 * @wann  Erste Zelle jeder auswählbaren Zeile, zusammen mit SelectionBar.
 */
