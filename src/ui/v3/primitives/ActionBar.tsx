 ...
 *
 * @wann  Die Handlungen eines Screens oder Dialog-Fußes, genau ein primärer Weg.
 * @nicht Handlungen an einer einzelnen Zeile → RowActions.
 */
 ...
 *
 * @wann  Ein bis drei Handlungen rechts in einer Tabellenzeile.
 * @nicht Mehr Handlungen → die Zeile bekommt ein Detail (MasterDetail), keine längere Leiste.
 */
